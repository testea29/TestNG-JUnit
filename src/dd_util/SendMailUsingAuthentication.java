...
public class SendMailUsingAuthentication
{
  ...
  public static final String SMTP_AUTH_USER = "abc@gmail.com";//Change the username
  public static final String SMTP_AUTH_PWD  = "abc";//Change the password
  ...
  public static final String[] emailList = {"abc@gmail.com"};//Change the mailing list
